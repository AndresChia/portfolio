        ...
        <div className="flex justify-between w-full px-16 py-8">
          <div>
            <ul className="flex flex-col text-left md:flex-row space-y-5 md:space-y-0 md:space-x-6 text-xl md:text-2xl">
              <li className="text-left hover:text-blue-400">
                <Link href="#experience">{i18n.experience}</Link>
              </li>
              <li className="text-left hover:text-blue-400">
          ...
          <div>
            <ul className="flex flex-col md:flex-row items-end md:items-center md:space-x-4 space-y-4 md:space-y-0">
              <li>
                <Link
                  href="https://github.com/AndresChia"
                  target="_blank"
                  aria-label="Github"
              ...
              <li>
                <Link
                  href="https://www.linkedin.com/in/andr%C3%A9s-felipe-chia-avila-75aa0a45/"
                  target="_blank"
                  aria-label="linkedin"
                  className="hover:text-blue-400"
                >
